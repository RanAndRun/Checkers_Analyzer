...
def handle_mouse_click(board, tile, first_selection, second_selection, is_white_to_play):
    if first_selection is None:
        ...
        board.move(first_selection, second_selection)
        first_selection = None
        second_selection = None
        is_white_to_play = not is_white_to_play
    return first_selection, second_selection, is_white_to_play
    ...
    while run:
        ...
        if mouse_on_tile and is_white_to_play:
            ...
            if mouse_clicked and mouse_on_pawn and mouse_on_pawn.color == EColor.white:
                first_selection, second_selection, is_white_to_play = handle_mouse_click(board, mouse_on_tile, first_selection, second_selection, is_white_to_play)
            elif mouse_clicked:
                first_selection, second_selection, is_white_to_play = handle_mouse_click(board, mouse_on_tile, first_selection, second_selection, is_white_to_play)
